...
export function AnimatedText({ text, delay = 0, className = "" }: AnimatedTextProps) {
  ...
  // default class kalau gak dikasih className dari luar
  const defaultClass = "font-bold text-center text-6xl leading-[0.75] tracking-tighter font-serif text-black lg:text-9xl"
